...
console.log("Connecting Mihiranga-MD Whatsapp User Bot 〽️♥️...");
...
console.log('〽️🫂 Mihiranga-MD Installing... ')
...
app.get("/", (req, res) => {
res.send("Hey, MihirangaMD Whatsapp User Bot Started 🫂♥️");
});
